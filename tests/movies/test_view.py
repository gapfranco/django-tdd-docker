...
def test_add_movie(client, settings):
...
@pytest.mark.django_db
def test_add_movie_invalid_json(client, settings):
    settings.SECURE_SSL_REDIRECT = False
    movies = Movie.objects.all()
    assert len(movies) == 0
...
@pytest.mark.django_db
def test_add_movie_invalid_json_keys(client, settings):
    settings.SECURE_SSL_REDIRECT = False
    movies = Movie.objects.all()
    assert len(movies) == 0
...
@pytest.mark.django_db
def test_get_single_movie(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
...
def test_get_single_movie_incorrect_id(client, settings):
    settings.SECURE_SSL_REDIRECT = False
...
@pytest.mark.django_db
def test_get_all_movies(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
...
@pytest.mark.django_db
def test_remove_movie(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
    movie = add_movie(title="The Big Lebowski", genre="comedy", year="1998")
...
@pytest.mark.django_db
def test_remove_movie_incorrect_id(client, settings):
    settings.SECURE_SSL_REDIRECT = False
...
@pytest.mark.django_db
def test_update_movie(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
    movie = add_movie(title="The Big Lebowski", genre="comedy", year="1998")
...
@pytest.mark.django_db
def test_update_movie_incorrect_id(client, settings):
    settings.SECURE_SSL_REDIRECT = False
...
@pytest.mark.django_db
def test_update_movie_invalid_json(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
    movie = add_movie(title="The Big Lebowski", genre="comedy", year="1998")
...
@pytest.mark.django_db
def test_update_movie_invalid_json_keys(client, add_movie, settings):
    settings.SECURE_SSL_REDIRECT = False
    movie = add_movie(title="The Big Lebowski", genre="comedy", year="1998")
...
# Pode substituir os ultimos dois acima:
@pytest.mark.django_db
...
def test_update_movie_invalid_json2(client, settings, add_movie, payload, status_code):
    settings.SECURE_SSL_REDIRECT = False
    movie = add_movie(title="The Big Lebowski", genre="comedy", year="1998")
    resp = client.put(
        f"/api/movies/{movie.id}/",
